    ...
    return (
        <article className="flex items-center p-4 rounded border-[rgba(0,0,0,0.1)] border-1 shadow-xs">
            ...
            <div className="ml-auto flex gap-0.5 bg-stone-50 text-stone-500 inset-shadow-2xs p-1 text-center rounded">
                ...
                <button className="p-1 transition-colors hover:bg-amber-600 hover:text-white rounded cursor-pointer"><LuPencilLine /></button>
                <button className="p-1 transition-colors hover:bg-red-600 hover:text-white rounded cursor-pointer"><LuTrash /></button>
            </div>
        </article>
    );
}